...
Complete this checklist before running Stage 1 for the first time. It only needs to be done once. If you want to change how the pipeline behaves on future runs, edit `_config/writing-conventions.md` directly.
...
When all items are checked, you're ready to run Stage 1.
